...
<<<<<<< HEAD
		...
		assertSame("Test that ChromebookList is added same as 3rd item of the list?", cb3, chromebookList.get(2));
=======
		// Item list is not null, so that can add a new item
=======
		//fail("Not yet implemented");
...
>>>>>>> branch 'master' of https://github.com/21041321-Seah-KaiLi/ResourceCentre_Student
		...
		//The item just added is as same as the first item of the list
		assertSame("Test that ChromebookList is added same as 1st item of the list?", cc1, chromebookList.get(0));
...
>>>>>>> branch 'master' of https://github.com/21041321-Seah-KaiLi/ResourceCentre_Student
=======
		assertSame("Test that Chromebook is added same as 3rd item of the list?", cc3, chromebookList.get(2));
>>>>>>> branch 'master' of https://github.com/21041321-Seah-KaiLi/ResourceCentre_Student
	}
...
>>>>>>> branch 'master' of https://github.com/21041321-Seah-KaiLi/ResourceCentre_Student
		...
		//error
<<<<<<< HEAD
		isReturned = ResourceCentre.doReturnChromebook(chromebookList, "Czb0013");
>>>>>>> branch 'master' of https://github.com/21041321-Seah-KaiLi/ResourceCentre_Student
...
=======
		...
		assertFalse("Test if non-existing  CC0013 is returned - false?", isReturned);
>>>>>>> branch 'master' of https://github.com/21041321-Seah-KaiLi/ResourceCentre_Student
	}
